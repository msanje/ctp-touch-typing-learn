...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-16 h-24 bg-white border-b border-gray-200 shadow-sm relative">
      {/* Logo */}
            ...
            <div className="flex flex-col space-y-4 border-b border-gray-200 pb-4">
              ...
              {navigationItems.map((item) => (
                <Link
                  ...
                  className="block text-base font-medium text-gray-700 hover:text-blue-600 bg-gray-50 transition-colors duration-200
          ...
          <div className="flex flex-col space-y-4">
            {session ? (
              <div>
                ...
                {/* We can add any additional user menu items here if needed */}
              </div>
            ) : (
