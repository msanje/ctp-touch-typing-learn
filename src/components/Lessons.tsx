...
const Lessons = () => {
    ...
    console.log("progressData completedExercises: ", completedExercises);
    ...
    const totalExercises = lessons && lessons.length > 0 ? lessons?.reduce((acc, { exercises }) => acc + (exercises?.length || 0), 0) : 0;
