    ...
    return (loading ? (
        ...
        error ? (<div>
            ...
            <div className="flex flex-col items-center justify-center h-screen w-full bg-gradient-to-b from-blue-100 to-gray-200">
                ...
                {
                    isDisabled && (
                        <ResultsModal wpm={wpm} typos={incorrectKeyStrokes} correctKeyStrokes={correctKeyStrokes} onTryAgain={handleTryAgain} onNext={handleNext} speed={speed} accuracy={accuracy} lessThenTwoTypos={lessThenTwoTypos} />
                    )
                }
