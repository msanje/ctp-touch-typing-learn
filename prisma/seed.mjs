    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "jjj jfj fjf jjf ffj fff jjff ffjj jjjf fffj",
          },
          {
            exerciseIndex: 6,
            content: "jjfff ffjjf jjfjf jfjfj fjjff fjjff ffffj jjjfj jjfff",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "rrr rtr trt rrt ttr ttt rrtt ttrr rrrt tttt",
          },
          {
            exerciseIndex: 6,
            content: "rrttt ttrrt rrttr trtrt trrtt trrtt ttttr rrrtr rrttt",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "uuu uyu yuy uuy yyu yyy uuyy yyuu uuuy yyyu",
          },
          {
            exerciseIndex: 6,
            content: "uuyyy yyuuy uuyuy uyuyu yuuyy yuuyy yyyyu uuuyu uuyyy",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "ddd dcd cdc ddc ccd ccc ddcc ccdd dddc cccd",
          },
          {
            exerciseIndex: 6,
            content: "ddccc ccddc ddcdc dcdcd cddcc cddcc ccccd dddcd ddccc",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "kkk kik iki kki iik iii kkii iikk kkki iiik",
          },
          {
            exerciseIndex: 6,
            content: "kkiii iikki kkiki kikik ikkii ikkii iiiki kkkik kkiii",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "hhh hnh nhn hhn nnh nnn hhnn nnhh hhhn nnnh",
          },
          {
            exerciseIndex: 6,
            content: "hhmmm mmhhm hhmhm hmhmh mhhmm mhhmm mmmmh hhhm hhmmm",
          },
        ],
      },
    },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          {
            exerciseIndex: 5,
            content: "ggg gbg bgb ggb bbg bbb ggbb bbgg gggb bbbg",
          },
          {
            exerciseIndex: 6,
            content: "ggbbb bbggb ggbgb gbgbg bggbb bggbb bbbbg gggbg ggbbb",
          },
        ],
      },
    },
